...
def _process_args():
    ...
    #---> train or test
    parser.add_argument('--test_only', type=str, default=False, help='whether is testing or training')
    parser.add_argument('--test_all', type=str, default=False, help='whether to test all data')
    parser.add_argument('--test_modality', type=str, default="path", help='which modality to test')
    parser.add_argument('--return_feature', type=str, default=False, help='whether returning features to visualize')
    ...
    parser.add_argument('--input_modality', type=str, default='path_and_gene', help='Use which modality to test')
    ...
    parser.add_argument('--memory_size', type=int, default=32, help='Size of memory bank')
    parser.add_argument('--complete_rate', type=float, default=1.0, help='rate of complete data')

    parser.add_argument('--sim_loss', type=float, default=0.2, help='weight of sim_loss')
    parser.add_argument('--align_loss', type=float, default=0.2, help='weight of align_loss')

    parser.add_argument('--use_align_loss', type=str, default=True, help='use align_loss')




    parser.add_argument('--proto_align_loss',   type=float, default=0.1) 
    parser.add_argument('--proto_triplet_loss', type=float, default=0.1) 
    parser.add_argument('--update_topk', type=int, default=16, help='Number of slots updated per sample')
